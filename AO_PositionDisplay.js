...
(function() {
	...
	class Sprite_Position extends Sprite_Base {
		...
		mapPositionText() {
			...
			return text = mapPositionStr + separatorStr + posX + positionSeparatorStr + posY;
		}
		...
		screenPositionText() {
			...
			return text = screenPositionStr + separatorStr + posX + positionSeparatorStr + posY;
		}
		...
		drawClickedPosition() {
			...
			const text = this.mapPositionText();
